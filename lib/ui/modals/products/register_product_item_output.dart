...
class RegisterProductIntemOutput extends StatefulWidget {
  RegisterProductIntemOutput({
    Key? key, 
    
  }) : super(key: key);

  @override
  State<RegisterProductIntemOutput> createState() => _RegisterProductIntemOutputState();
}

class _RegisterProductIntemOutputState extends State<RegisterProductIntemOutput> {
              ...
              Container(
                ...
                child: CustomFlatButton(onPressed: () {
                    ...
                    final productItem = ProductItem(
                      ...
                      productsItemProvider.addItemMovementOutput(productItem);
